  ...
  <Wrapper>
    ...
    {facebook && (
      <SocialLink href={facebook} target="_blank" rel="noopener">
        ...
        >
          <path
            d="M40.43 21.74h-7.645v-5.014c0-1.883 1.248-2.322 2.127-2.322h5.395V6.125l-7.43-.03c-8.248 0-10.125 6.174-10.125 10.125v5.518h-4.77v8.53h4.77v24.137h10.033V30.27h6.77l.875-8.53z"
            fill="currentcolor"
          />
        </svg>
        Facebook
